...
- [ ] What steps can you take in your web apps to keep your data secure?
  Issuing tokens, logging in, removing tokens, private routes/protected routes, security tokens.
- [ ] Describe how web servers work.
  Act like a large computer, the cycle of DNS, IPs, sending requests as an address, receiving data for the request.
